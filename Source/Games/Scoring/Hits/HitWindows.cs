...
namespace UniBeat.RhythmEngine
{
    ...
    {
        // In Milliseconds
        private static readonly List<DifficultyRange> base_ranges = new List<DifficultyRange>()
        {
        ...
        public void SetDifficulty(double difficulty)
        {
            ...
            {
                var value = GameDifficulty.DifficultyRange(difficulty, (range.Min, range.Average, range.Max));
        ...
        /// </summary>
        /// <param name="timeOffset">The time offset as an unsigned absolute value.</param>
        ...
        /// This happens if <paramref name="offsetMs"/> is less than what is required for <see cref="LowestSuccessfulHitResult"/>.
        /// </summary>
        /// <param name="offsetMs">The time offset in milliseconds.</param>
        /// <returns>Whether the <see cref="HitObject"/> can be hit at any point in the future from this time offset.</returns>
        public bool CanBeHit(double offsetMs) => offsetMs <= WindowFor(LowestSuccessfulHitResult());
        ...
        /// </summary>
        protected virtual IList<DifficultyRange> GetRanges() => base_ranges;

        public class EmptyHitWindows : HitWindows
        {
            private static readonly List<DifficultyRange> ranges = new List<DifficultyRange>()
            {
            ...
            protected override IList<DifficultyRange> GetRanges() => ranges;
        }
    }
    ...
    public struct DifficultyRange
    {
        ...
        // Time offset to achieve `Result` when the difficulty is set to 0.
        public double Min;

        // Time offset to achieve `Result` when the difficulty is set to 5.
        public double Average;

        // Time offset to achieve `Result` when the difficulty is set to 10.
        public double Max;
